...
three = lp.high_pass(data, cutoff=20 / 256, gaussian=True)
fig, [[ax1, ax2]] = lp.subplots(12)
...
four = lp.low_pass(data, cutoff=20 / 256, gaussian=True)
fig, [[ax1, ax2]] = lp.subplots(12)
...
seven = lp.ndap(data)
seven.high_pass(cutoff=20 / 256, gaussian=True)
fig, [[ax1, ax2]] = lp.subplots(12)
ax1.set_title("high pass, gaussian")
ax1.imshow(seven.real)
ax2.ax.plot(seven.real[32])
...
seven = lp.ndap(data)
seven.low_pass(cutoff=20 / 256, gaussian=True)
fig, [[ax1, ax2]] = lp.subplots(12)
ax1.set_title("low pass, gaussian")
ax1.imshow(seven.real)
ax2.ax.plot(seven.real[32])
